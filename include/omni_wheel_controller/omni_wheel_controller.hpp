...
#include "omni_wheel_controller/speed_limiter.hpp"
...
#include <omni_wheel_controller/omni_wheel_controller_parameters.hpp>
...
protected:
  ...
  controller_interface::CallbackReturn configure_handles(
    const std::vector<std::string> & wheel_names,
    std::vector<WheelHandle> & registered_handles);

  std::vector<WheelHandle> registered_omni_wheel_handles_;

  // Parameters from ROS for omni_wheel_controller
